...
import nl.wernerdegroot.guetta.core.optics.GetterSetterWithEffect;
...
public record GetterSetterWithEffectImpl<Structure, Value>(
        Getter<Structure, Value> getter,
        SetterWithEffect<Structure, Value> setterWithEffect
) implements GetterSetterWithEffect<Structure, Value> {
